...
export default function WizardPage() {
  ...
  if (isCatalogLoading || isAuditLoading || !currentSection) {
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="space-y-3 text-center">
          <div className="mx-auto h-12 w-12 animate-spin rounded-full border-4 border-primary/20 border-t-primary" />
          <p className="text-sm font-medium text-muted-foreground">
            Cargando catálogo y auditoría...
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto pb-24">
      ...
      <div className="flex-1 space-y-10 min-w-0">
        <WizardHeader section={currentSection} currentIndex={currentStepIndex} totalSections={isoData.length} />
