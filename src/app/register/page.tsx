...
import { Shield, UserPlus, Mail, User, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 shadow-xl border-t-4 border-t-primary animate-in fade-in zoom-in duration-300">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black text-[#1a365d] tracking-tight">Crear Cuenta</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Rol en el Sistema</label>
            <select
              name="roleId"
              className="w-full px-4 py-2.5 bg-muted/30 border border-border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none text-sm appearance-none cursor-pointer"
          ...
          <p className="text-center text-xs text-muted-foreground pt-4">
            ¿Ya tienes una cuenta? <Link href="/" className="text-primary font-bold hover:underline">Inicia sesión aquí</Link>
          </p>
        </form>
      </Card>
    </div>
